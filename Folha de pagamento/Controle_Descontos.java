...
public class Controle_Descontos extends javax.swing.JFrame {

    conexao_banco var = new conexao_banco();
    public int Codigo = -1;
    public String SCodigo = null;
    
    public Controle_Descontos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Controle de descontos");
        setResizable(false);
        ...
        jLabel5.setText("Controle de descontos");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        var.conecta();
        if(SCodigo == null){
            showMessageDialog(this,"Consulte o código de desconto que deseja excluir primeiro!", "Consulte primeiro", 1);
            txt_cod.requestFocus();
            return;
        }
        try{
            int edit = var.stmt.executeUpdate("delete from Tabela_Descontos where Codigo_desc = " + txt_cod.getText() + " ");
            if (edit!=0){
                showMessageDialog(this,"Código de desconto =>  " + txt_cod.getText() + " excluido com sucesso!!", "Registo excluido", 1);
                limpar();
            }
            var.stmt.close();
            var.con.close();
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
            ...
            var.RS= var.stmt.executeQuery("select * from Tabela_Descontos where Codigo_desc=" + CodCadastra + "");
            while (var.RS.next()){
                consulta_func = true;
            }
            if(!consulta_func){
                PreparedStatement stmt = var.con.prepareStatement("insert into Tabela_Descontos (Codigo_desc,Descricao,Quantidade,Valor) values (?,?,?,?)");
                ...
                stmt.close();
                var.con.close();
                showMessageDialog( this, "Código de desconto => " + CodCadastra + " cadastrado com sucesso!!", "Cadastrado com sucesso", 1);
                limpar();
            }else{
                showMessageDialog(this,"Código de desconto => " + CodCadastra + " já cadastrado!", "Código já cadastrado",2);
            }
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        try{
            while (Codigo == -1) {
                SCodigo = showInputDialog(this, "Digite o código de desconto que você deseja consultar", "Qual o código de desconto?", 3);
            ...
            var.RS = var.stmt.executeQuery("select * from Tabela_Descontos where Codigo_desc = " + Codigo + "");

            while(var.RS.next()){
                consultaChapa = true;
                txt_cod.setText(var.RS.getString("Codigo_desc"));
            ...
            if(!consultaChapa){
                showMessageDialog(this,"Código de desconto => " + Codigo + " não existe!", "Código inválido", 1);
                limpar();
            }
            var.stmt.close(); 
            var.con.close();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if(SCodigo == null){
            showMessageDialog(this,"Consulte o código de desconto que deseja alterar primeiro!", "Consulte primeiro", 1);
            return;
        }
        try{
            ...
            PreparedStatement stmt = var.con.prepareStatement("update Tabela_Descontos set Codigo_desc = ?, Descricao=?, Quantidade=?, Valor=? where Codigo_desc =" + CodAltera + "");
            ...
            showMessageDialog(this,"Código de desconto => " + CodAltera + " alterado com sucesso!!", "Registo alterado", 1);
            limpar();
        }
        catch( SQLException e){
            showMessageDialog(this, "Comando SQL com problemas " + e.getMessage() );
    ...
    private static int stringToInt(String string) {
        try {
            ...
            if(string == null || string.equals("")){
                showMessageDialog(null,"Digite uma código de desconto válido! ", "Digite código valido", 1);
            }else{
                showMessageDialog(null,"Digite somente números para consultar o código de desconto! ", "Somente números", 1);
            }          
            return -1;
        }   
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Controle_Descontos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
